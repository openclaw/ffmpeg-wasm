...
const configureFlags = [
  ...
  "--enable-swresample",
  "--enable-swscale",
  "--enable-decoder=h264,hevc,vp8,vp9,aac,mp3,flac,vorbis,opus,pcm_s16le,png,mjpeg",
  "--enable-parser=h264,hevc,vp8,vp9,aac,mpegaudio,opus,vorbis,png,mjpeg",
  "--enable-demuxer=mov,matroska,mp3,wav,flac,ogg,aac,mpegts,hls,image2",
  "--enable-muxer=null,rawvideo,image2,wav,segment,mp3",
  "--enable-encoder=png,rawvideo,wrapped_avframe,pcm_s16le,libmp3lame",
